...
export class ComparisonBarChartComponent implements AfterViewInit, OnChanges, OnDestroy {
  ...
  private readonly tooltipId = `comparison-chart-tooltip-${crypto.randomUUID()}`;
